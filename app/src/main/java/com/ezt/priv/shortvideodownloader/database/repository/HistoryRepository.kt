...
class HistoryRepository2(private val historyDao: HistoryDao, private val segmentedVideoDao: SegmentedVideoDao) {
    ...
    suspend fun getSegmentedVideo(name: String) : List<SegmentedVideo> {
        return segmentedVideoDao.getSegmentedVideo(name)
    }
