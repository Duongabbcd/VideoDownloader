...
import com.ezt.priv.shortvideodownloader.receiver.activities.ShareActivity
import com.ezt.priv.shortvideodownloader.ui.BaseActivity
import com.ezt.priv.shortvideodownloader.ui.adapter.ConfigureMultipleDownloadsAdapter
...
class DownloadMultipleBottomSheetDialog : BottomSheetDialogFragment(), ConfigureMultipleDownloadsAdapter.OnItemClickListener, View.OnClickListener,
    ...
    companion object {
        private const val ARG_DOWNLOAD_IDS = "arg_download_ids"

        fun newInstance(downloadIds: LongArray): DownloadMultipleBottomSheetDialog {
            val fragment = DownloadMultipleBottomSheetDialog()
            val args = Bundle()
            args.putLongArray(ARG_DOWNLOAD_IDS, downloadIds)
    ...
    private val downloadIds: LongArray by lazy {
        arguments?.getLongArray(ARG_DOWNLOAD_IDS) ?: longArrayOf()
    }
