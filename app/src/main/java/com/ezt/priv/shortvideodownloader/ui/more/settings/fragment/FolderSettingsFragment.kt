package com.ezt.priv.shortvideodownloader.ui.more.settings.fragment
...
import com.ezt.priv.shortvideodownloader.work.MoveCacheFilesWorker
...
class FolderSettingsFragment : BaseSettingsFragment() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        if (preferences.getString("music_path", "")!!.isEmpty()) {
            editor.putString("music_path", FileUtil.getDefaultAudioPath(requireContext())).apply()
        }
        if (preferences.getString("video_path", "")!!.isEmpty()) {
            editor.putString("video_path", FileUtil.getDefaultVideoPath(requireContext())).apply()
        }
        if (preferences.getString("command_path", "")!!.isEmpty()) {
            editor.putString("command_path", FileUtil.getDefaultCommandPath(requireContext())).apply()
        }
