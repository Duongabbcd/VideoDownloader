package com.ezt.priv.shortvideodownloader.ui.more.settings.fragment.advanced
...
import com.ezt.priv.shortvideodownloader.ui.adapter.YoutubePlayerClientAdapter
        ...
        for(p in poTokenInputs) {
            p.setEndIconOnClickListener {
                val clipboard: ClipboardManager = requireActivity().getSystemService(
                    AppCompatActivity.CLIPBOARD_SERVICE) as ClipboardManager
