package com.ezt.priv.shortvideodownloader.util.extractors.newpipe
...
import com.ezt.priv.shortvideodownloader.util.extractors.newpipe.potoken.NewPipePoTokenGenerator
...
// Check if it has a valid scheme and host
            ...
            Log.e("getTrending", "Unexpected error in getTrending", err)
            err.printStackTrace()
            arrayListOf()
        }
    }
