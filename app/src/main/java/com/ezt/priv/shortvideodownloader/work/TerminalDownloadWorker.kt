...
import com.ezt.priv.shortvideodownloader.ui.more.terminal.TerminalActivity
...
class TerminalDownloadWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        val dao = VideoDownloadDB.getInstance(context).terminalDao
        ...
        val downloadLocation = sharedPreferences.getString("command_path", FileUtil.getDefaultCommandPath(context))
        request.addOption(
            "--config-locations",
        ...
        val commandPath = sharedPreferences.getString("command_path", FileUtil.getDefaultCommandPath(context))!!
        ...
        kotlin.runCatching {
            ...
            notificationUtil.cancelDownloadNotification(itemId)
            File(FileUtil.getDefaultCommandPath(context) + "/" + itemId).deleteRecursively()
