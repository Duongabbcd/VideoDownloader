...
class OkHttpProxyClient @Inject constructor(
    ...
    private var currentProxy: com.ezt.video.downloader.ui.browse.qualifier.Proxy
    ...
    fun getProxyOkHttpClient(): OkHttpClient {
        ...
        if (proxy.host != currentProxy.host && proxy.port != currentProxy.port || (httpClientCached == null)) {
            ...
            httpClientCached =
                if (proxy == com.ezt.video.downloader.ui.browse.qualifier.Proxy.noProxy()) {
    ...
    private fun getProxy(): com.ezt.video.downloader.ui.browse.qualifier.Proxy {
