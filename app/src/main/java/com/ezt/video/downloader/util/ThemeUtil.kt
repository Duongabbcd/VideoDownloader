...
object ThemeUtil {
    ...
    fun updateTheme(activity: Activity) {
        ...
        for (appIcon in availableIcons) {
            val activityClass = "com.ezt.video.downloader." + appIcon.activityAlias
        ...
        when (sharedPreferences.getString("video_downloader", "System")!!) {
            "System" -> {
                //set dynamic icon
                activity.packageManager.setComponentEnabledSetting(
                    ComponentName(activity.packageName, "com.ezt.video.downloader.Default"),
            ...
            "Light" -> {
                //set light icon
                activity.packageManager.setComponentEnabledSetting(
                    ComponentName(activity.packageName, "com.ezt.video.downloader.LightIcon"),
                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
                    PackageManager.DONT_KILL_APP
                )
            ...
            "Dark" -> {
                //set dark icon
                activity.packageManager.setComponentEnabledSetting(
                    ComponentName(activity.packageName, "com.ezt.video.downloader.DarkIcon"),
                    PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
                    PackageManager.DONT_KILL_APP
                )
